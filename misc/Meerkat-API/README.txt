...
----------------------------------------------------------------------
Requires Poker Academy Pro 1.5.1 or later.
----------------------------------------------------------------------
...
----------------------------------------------------------------------
  ...
  * Action objects are used for representing actions rather than integer codes
  * Action events are now sent *before* GameInfo is updated.
  * After the GameInfo is updated, a gameStateChangedEvent() is fired
  * newGame() is replaced with holeCards() and gameStartEvent()
  * action() is replaced with getAction()
